...
echo -e "	${WHITE}      👑  juegos	     ${GREEN}: accede el menú de juegos"
...
echo -e "	${WHITE}      👑  buscar      ${GREEN}:este comando recibe dos argumentos: archivo a buscar y directorio donde se va a buscar"
echo -e "       ${WHITE}      👑  alv         ${GREEN}: sale de la prebeshell"
echo " "
echo ""
echo ""
